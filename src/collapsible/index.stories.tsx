    ...
    <Collapsible className="w-[350px] space-y-2">
      ...
      <CollapsibleContent className="rounded-md border p-4">
        <p className="text-muted-foreground text-sm">
          This is the expanded content. It can contain any type of content, including text, images, or other components.
        </p>
      </CollapsibleContent>
    </Collapsible>
  ),
    ...
    <Collapsible className="w-[350px] space-y-2">
      ...
      <CollapsibleContent className="space-y-2">
        <Collapsible>
          ...
          <CollapsibleContent className="rounded-md border p-4">
            <p className="text-muted-foreground text-sm">This is the content of child section 1.</p>
          </CollapsibleContent>
        </Collapsible>
        <Collapsible>
          <CollapsibleTrigger className="hover:bg-muted flex w-full items-center justify-between rounded-md border p-4">
          ...
          <CollapsibleContent className="rounded-md border p-4">
            <p className="text-muted-foreground text-sm">This is the content of child section 2.</p>
          </CollapsibleContent>
        </Collapsible>
      </CollapsibleContent>
    </Collapsible>
  ...
  render: () => (
    <Collapsible className="w-[350px] space-y-2">
      ...
      <CollapsibleContent className="rounded-md border border-blue-200 bg-blue-50 p-4">
        <p className="text-sm text-blue-800">This collapsible has a custom blue theme applied to it.</p>
      </CollapsibleContent>
    </Collapsible>
  ),
}
    ...
    <Collapsible className="w-[350px] space-y-2">
      ...
      <CollapsibleContent className="space-y-4 rounded-md border p-4">
        <div className="space-y-2">
          ...
          <textarea className="w-full rounded-md border p-2 text-sm" rows={3} placeholder="Enter additional notes..." />
        </div>
        <div className="space-y-2">
          <label className="text-sm font-medium">Tags</label>
          <input type="text" className="w-full rounded-md border p-2 text-sm" placeholder="Enter tags..." />
        </div>
      </CollapsibleContent>
    </Collapsible>
  ),
...
export const WithAnimation: Story = {
  render: () => (
    <Collapsible className="w-[350px] space-y-2">
      ...
      <CollapsibleContent className="data-[state=closed]:animate-collapse data-[state=open]:animate-expand overflow-hidden transition-all duration-300 ease-in-out">
        <div className="rounded-md border p-4">
          <p className="text-muted-foreground text-sm">This content has a custom animation applied to it.</p>
        </div>
      </CollapsibleContent>
    </Collapsible>
  ),
